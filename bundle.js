...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ToggleAnnotations = __webpack_require__(201);

	var _ToggleAnnotations2 = _interopRequireDefault(_ToggleAnnotations);

	var _ViewAnnotations = __webpack_require__(202);

	var _ViewAnnotations2 = _interopRequireDefault(_ViewAnnotations);
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    _this.handleClick = function (click) {
	      _this.setState({ click: click });
	    };
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'li',
	              null,
	              'App.js manages state and passes a handle input function to ToggleAnnotations through props.'
	            ),
	            _react2.default.createElement(
	              'li',
	              null,
	              'ToggleAnnotations.js receives input (onClick event) and passes calls the function from App.js'
	            ),
	            _react2.default.createElement(
	              'li',
	              null,
	              'ViewAnnotations.js displays input through props.'
	            )
	          ),
	          _react2.default.createElement(
	            'div',
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'main' },
	          _react2.default.createElement(_ToggleAnnotations2.default, { onClick: this.handleClick }),
	          _react2.default.createElement(_ViewAnnotations2.default, { value: this.state.click })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToggleAnnotations = function (_Component) {
	  _inherits(ToggleAnnotations, _Component);

	  function ToggleAnnotations(props) {
	    _classCallCheck(this, ToggleAnnotations);

	    return _possibleConstructorReturn(this, (ToggleAnnotations.__proto__ || Object.getPrototypeOf(ToggleAnnotations)).call(this, props));
	  }

	  _createClass(ToggleAnnotations, [{
	    key: 'onClick',
	    value: function onClick(value) {
	      var val = value.target;
	      var data = val.getAttribute("data-value");
	      // document.querySelector('.container'));
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { onClick: this.onClick.bind(this), 'data-value': 'view' },
	            'View annotation'
	          ),
	          _react2.default.createElement(
	            'button',
	            { onClick: this.onClick.bind(this), 'data-value': 'write' },
	            'Write annotation'
	          )
	        )
	      );
	...
	exports.default = ToggleAnnotations;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ViewAnnotations = function (_Component) {
	  _inherits(ViewAnnotations, _Component);

	  function ViewAnnotations(props) {
	    _classCallCheck(this, ViewAnnotations);

	    return _possibleConstructorReturn(this, (ViewAnnotations.__proto__ || Object.getPrototypeOf(ViewAnnotations)).call(this, props));
	    // declare state if needed
	  }

	  _createClass(ViewAnnotations, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	...
	exports.default = ViewAnnotations;
